<script setup lang="ts">
    ...
    function account_click(target: string) {
        if(target == current_account.value) { return }
...
<template>
    <div id="all">
        <div id="top">
            <MyCheckButton :isChecked="current_account == 'Microsoft'" :class="current_account == 'Microsoft' ? 'login-button-active' : ('login-button-style cursor-pointer')" @click="account_click('Microsoft')">
                <svg
                    role="img"
            ...
            <MyCheckButton :isChecked="current_account == 'Offline'" :class="current_account == 'Offline' ? 'login-button-active' : ('login-button-style cursor-pointer')" @click="account_click('Offline')">
                <svg
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
