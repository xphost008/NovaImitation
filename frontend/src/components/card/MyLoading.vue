...
<template>
  <div class="ala">
    <svg
      ...
      <path d="M 80 120 Q 95 100 130 100 Q 140 80 150 100 Q 180 100 200 120 Q 150 100 145 110 L 145 190 L 135 190 L 135 110 M 80 120 Q 120 100 135 110" :class="current_state != 0 ? 'loading-stop' : 'loading'"/>
