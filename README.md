...
为什么取名叫做Nova Imitation？因为Nova这个项目本身就是用tauri写的，而我又做了个仿制版，因此称其为Nova Imitation！

这个项目以后说不定会更新，我得看Nova的发布进度来进行更新~
...
本软件如果你右键并查看属性的话，你可能会发现这个项目的原始文件名为tank_trait_trigger。

因为我之前说过，我打算做的TTT启动器就是用tauri写的，但是由于迟迟未动工，因此也就直接拿来做Nova Imitation啦！
